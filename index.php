...
<html lang="en">
  ...
  <nav>
    ...
    <br>
    <a href="https://dylan-sauvat.students-laplateforme.io/" class="text-white hover:text-gray-300 mr-4">Plesk</a>
  </nav>
</header>
    <main class="p-6">
      ...
      <section id="cv" class="bg-white p-6">
    <h2 class="text-xl font-medium mb-4">CV</h2>
    <p>Téléchargez mon CV en cliquant sur le lien ci-dessous :</p>
    <a href="https://dylan-sauvat.students-laplateforme.io/CV%20SAUVAT%20DYLAN%202022.pdf.pdf" class="text-blue-500">Télécharger mon CV</a>
</section>
